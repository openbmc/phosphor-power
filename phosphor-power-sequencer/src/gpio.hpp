...
class GPIO
{
  public:
     ...
     *
     * @param consumer application requesting ownership of the GPIO
     * @param type specifies whether requesting to read or write the GPIO
     */
    virtual void request(const std::string& consumer, RequestType type) = 0;
...
class BMCGPIO : public GPIO
{
  public:
    ...
    virtual void request(const std::string& consumer, RequestType type) override
    {
        int lineRequestType;
        ...
        line.request({consumer, lineRequestType, 0});
    }
