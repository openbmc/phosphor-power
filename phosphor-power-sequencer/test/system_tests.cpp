...
TEST(SystemTests, Monitor)
{
    ...
    // Test where works: Initial selected chassis: Does not set: Already set by
    // setPowerState()
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
    ...
    // Test where works: Initial selected chassis: All chassis have good status
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial selected chassis: Some chassis have good
    // status: One is not present
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial selected chassis: No chassis have good status:
    // One is not available: One does not have good input power
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial selected chassis: First chassis throws
    // exception when finding status: Verify still checks second chassis
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial selected chassis: All chassis off
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial selected chassis: All chassis on
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial selected chassis: One chassis on and one off
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Setting power good: Does not set: No chassis selected
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Setting power good: All chassis are selected
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Setting power good: Some chassis are selected
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Setting power good: First selected chassis throws an
    // exception reading power good: Verify continues to second chassis
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Setting power good: All selected chassis are on
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Setting power good: All selected chassis are off
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Setting power good: Selected chassis have different
    // power good values
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
    ...
    // Test where works: Initial power state: Does not set: Already set
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial power state: Does not set: Power good does
    // not have value
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
    ...
    // Test where works: Initial power state: Sets to on
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
    ...
    // Test where works: Initial power state: Sets to off
    {
        std::vector<std::unique_ptr<Chassis>> chassis;
        chassis.emplace_back(
            createChassis(1, "/xyz/openbmc_project/inventory/system/chassis1"));
