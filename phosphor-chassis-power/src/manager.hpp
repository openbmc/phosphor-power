...
class Manager
{
  ...
  private:
     ...
     */
    void blackoutTargetStarted(sdbusplus::message_t& msg);
    ...
    /**
     * D-Bus match object for monitoring systemd JobNew signals to detect
     * when the obmc-chassis-blackout@0.target starts.
     */
    std::unique_ptr<sdbusplus::match> blackoutTargetMatch;
