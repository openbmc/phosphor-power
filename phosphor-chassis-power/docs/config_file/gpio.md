...
| Default   | No       | string | Optional default polarity value. Either "Low" or "High". If not specified, |
|           |          |        | the GPIO has no default value and getDefault() will return std::nullopt    |
