...
config file is used: SHELDON: would this be `chassis-power-use-config-file`
...
Each GPIO property (PresenceGpio, FaultUnlatchedGpio, etc.) is an array
containing GPIO objects with the following properties:
