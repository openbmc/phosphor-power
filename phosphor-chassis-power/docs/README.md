...
If the power chassis device type is not supported, `phosphor-chassis-power`
can still power the system on/off. SHELDON: I think this is wrong.

## JSON configuration file

`phosphor-chassis-power` is configured by a JSON configuration file.
The configuration file defines the GPIOs in the system and how they
should be monitored.
...
`phosphor-chassis-power` can still power the system on/off. SHELDON: I think this is wrong.
