...
The `phosphor-chassis-power` application monitors GPIOs in systems with single
or multiple chassis. It uses GPIOs to determine chassis presence and input power
fault status to handle failures, and to enable any chassis cleanup or
...
The existing
[PowerSystemInputs](/openbmc/phosphor-dbus-interfaces/yaml/xyz/openbmc_project/State/Decorator/PowerSystemInputs.interface.yaml)
