...
TEST(PresenceDetectionTests, Execute)
{
    ...
    // Test where fails
    {
        // Create mock services and mock presenceService. Reading presence
        // failed.
        MockServices services{};
        MockPresenceService& presenceService =
            services.getMockPresenceService();
