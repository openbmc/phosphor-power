...
void expectFileValid(const std::string& tmpFile)
{
    ...
    std::string tempOutputMessage = "";
    EXPECT_EQ(runToolForOutput(tmpFile, tempErrorMessage, true), 0);
    EXPECT_EQ(runToolForOutput(tmpFile, tempOutputMessage), 0);
    EXPECT_EQ(tempErrorMessage, "");
    EXPECT_EQ(tempOutputMessage, "");
}
                       ...
                       const std::string& expectedOutputMessage)
{
    std::string tempErrorMessage = "";
    std::string tempOutputMessage = "";
    EXPECT_EQ(runToolForOutput(tmpFile, tempErrorMessage, true), 1);
    EXPECT_EQ(runToolForOutput(tmpFile, tempOutputMessage), 1);
    EXPECT_EQ(tempErrorMessage, expectedErrorMessage);
    EXPECT_EQ(tempOutputMessage, expectedOutputMessage);
}
