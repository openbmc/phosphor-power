...
TEST(ValidateRegulatorsConfigTest, Devices)
{
    ...
    // Invalid: test devices with property fru lenth less than 1.
    {
        json configFile = validConfigFile;
...
TEST(ValidateRegulatorsConfigTest, I2CCompareByte)
{
    ...
    // Invalid: test i2c_compare_byte with property register wrong format.
    {
        json configFile = i2cCompareByteFile;
        configFile["rules"][0]["actions"][1]["i2c_compare_byte"]["register"] =
            "0x820";
    ...
    // Invalid: test i2c_compare_byte with property value wrong format.
    {
        json configFile = i2cCompareByteFile;
    ...
    // Invalid: test i2c_compare_byte with property mask wrong format.
    {
        json configFile = i2cCompareByteFile;
...
TEST(ValidateRegulatorsConfigTest, I2cWriteByte)
{
    ...
    i2cWriteByteFile["rules"][0]["actions"][1]["i2c_write_byte"]["mask"] =
        "0x7F";
    // Valid: test i2c_write_bytes with all properties.
    {
    ...
    // Invalid: test i2c_write_bytes with property register wrong format.
    {
        json configFile = i2cWriteByteFile;
    ...
    // Invalid: test i2c_write_bytes with property values wrong format.
    {
        json configFile = i2cWriteByteFile;
    ...
    // Invalid: test i2c_write_bytes with property masks wrong format.
    {
        json configFile = i2cWriteByteFile;
...
TEST(ValidateRegulatorsConfigTest, DuplicateGlobalID)
{
...
TEST(ValidateRegulatorsConfigTest, InfinitLoops)
{
