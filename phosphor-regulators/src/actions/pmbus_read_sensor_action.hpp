...
class PMBusReadSensorAction : public I2CAction
{
  public:
     ...
     *
     * The command is the register to read from the PMBus command code data member.
     *
     * The sensor data format is specified in the constructor. Currently only the
     * linear_11 and linear_16 format is supported.
     *
