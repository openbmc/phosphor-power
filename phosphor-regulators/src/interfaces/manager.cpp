...
const sdbusplus::vtable::vtable_t Manager::_vtable[] = {
    ...
    sdbusplus::vtable::method("Configure",
        details::Manager::_param_Configure.data(),
        details::Manager::_return_Configure.data(),
        _callbackConfigure),
    sdbusplus::vtable::method("Monitor",
        details::Manager::_param_Monitor.data(),
        details::Manager::_return_Monitor.data(),
        _callbackMonitor),
