...
void PSUManager::getSystemProperties()
{
    ...
    {
        // Interface not found, subscribe to interfaces added
        entityManagerIfacesAddedMatch =
            std::make_unique<sdbusplus::bus::match_t>(
                bus,
                sdbusplus::bus::match::rules::interfacesAdded() +
                    sdbusplus::bus::match::rules::sender(
                        "xyz.openbmc_project.EntityManager"),
                std::bind(std::mem_fn(&PSUManager::supportedConfIfaceAdded),
...
void PSUManager::supportedConfIfaceAdded(sdbusplus::message::message& msg)
{
    ...
    // Supported Configuration interface found, don't need the match anymore
