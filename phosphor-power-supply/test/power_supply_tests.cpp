...
void setPMBusExpectations(MockedPMBus& mockPMBus, uint16_t statusWordValue,
                          uint8_t statusInputValue, uint8_t statusMFRValue,
                          uint8_t statusCMLValue, uint8_t statusVOUTValue)
{
    // grr... annoying blank function formatting!
    ...
    if (statusWordValue != 0)
    {
        ...
        // STATUS_INPUT, STATUS_MFR, STATUS_CML, and STATUS_VOUT.
