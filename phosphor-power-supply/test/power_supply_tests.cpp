...
static unsigned int PSUBindDelay = 457;
...
TEST_F(PowerSupplyTests, Analyze)
{
    ...
    PowerSupply psu{bus,  PSUInventoryPath, 4,
                    0x69, PSUGPIOLineName,  PSUBindDelay};
    ...
    PowerSupply psu2{bus,  PSUInventoryPath, 5,
                     0x6a, PSUGPIOLineName,  PSUBindDelay};
...
TEST_F(PowerSupplyTests, ClearFaults)
{
    ...
    PowerSupply psu{bus,  PSUInventoryPath, 13,
                    0x68, PSUGPIOLineName,  PSUBindDelay};
    MockedGPIOReader* mockPresenceGPIO =
        static_cast<MockedGPIOReader*>(psu.getPresenceGPIO());
...
TEST_F(PowerSupplyTests, IsFaulted)
{
    ...
    PowerSupply psu{bus,  PSUInventoryPath, 11,
                    0x6f, PSUGPIOLineName,  PSUBindDelay};
    MockedGPIOReader* mockPresenceGPIO =
        static_cast<MockedGPIOReader*>(psu.getPresenceGPIO());
