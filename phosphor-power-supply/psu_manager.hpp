...
class PSUManager
{
  ...
  private:
    ...
    /**
     * @brief Set the power-config-full-load GPIO depending on the number of
     *        power supplies the system should have.
     */
     ...
     */
    std::unique_ptr<GPIOInterface> powerConfigGPIO = nullptr;
};
