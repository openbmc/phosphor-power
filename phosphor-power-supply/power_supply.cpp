    ...
    inventoryPath(invpath), bindDelay(bindDelay)
{
    ...
    // Ref:
    // https://training.ti.com/sites/default/files/docs/slides-i2c-intro-reserved-addresses.pdf
    // if ((0 == i2caddr) || (1 == i2caddr) || (0x02 == (i2caddr & 0x02)) ||
    //    (0x04 == (i2caddr & 0x04)) || (0x7C == (i2caddr & 0x7C)) ||
    //    (0x78 == (i2caddr & 0x78)))
    //{
    //    throw std::invalid_argument{"Invalid reserved i2caddr"};
    //}
