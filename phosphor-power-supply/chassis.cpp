...
constexpr auto chassisObjectManagerObjPath =
    "/xyz/openbmc_project/power/power_supplies/{}/psus";
constexpr auto chassisObjectSensorsPath = "/xyz/openbmc_project/{}/sensors";
...
Chassis::Chassis(sdbusplus::bus_t& bus, const std::string& chassisPath,
    ...
    tmpObjectManagerPath(
        std::format(chassisObjectManagerObjPath, chassisShortName)),
    chassisObjectManager(bus, tmpObjectManagerPath.c_str()),
    tmpSensorObjectManagerPath(
        std::format(chassisObjectSensorsPath, chassisShortName)),
    chassisSensorsObjManager(bus, tmpSensorObjectManagerPath.c_str()),
    eventLoop(e)
{
    getPSUConfiguration();
