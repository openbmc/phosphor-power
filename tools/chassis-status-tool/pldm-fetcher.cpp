    ...
    catch (const std::exception& e)
    {
        if (verbose)
        {
            std::println(stderr,
                         ...
                         " failed: {}",
                         mediumIndent, stateSetId, entityType, e.what());
        }
    }
    return results;
}
    ...
    if (rc != PLDM_REQUESTER_SUCCESS)
    {
        if (verbose)
        {
            std::println(stderr,
                         ...
                         "for sensorID={}: rc={}",
                         mediumIndent, sensorId, static_cast<int>(rc));
        }
        return std::nullopt;
    }
...
void PldmFetcher::display(int chassisNumber) const
{
    ...
    if (pldmPropMap.at("Available"))
    {
        std::print("{}Availability: ", mediumIndent);
    ...
    if (pldmPropMap.at("Present"))
    {
        std::print("{}Present: ", mediumIndent);
    ...
    if (pldmPropMap.at("PowerState"))
    {
        std::print("{}Power State: ", mediumIndent);
    ...
    if (pldmPropMap.at("OperationalFaultStatus"))
    {
        std::print("{}Operational Fault Status: ", mediumIndent);
        printSensorState(
