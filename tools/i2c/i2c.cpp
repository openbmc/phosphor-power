...
void I2CDevice::write(uint8_t addr, uint8_t data)
{
    ...
    if (ret == -1)
    {
        throw I2CException(busStr, devAddr, errno, "Failed to write");
    }
}
...
void I2CDevice::write(uint8_t addr, uint8_t size, const uint8_t* data)
{
    ...
    {
        case 0:
            throw I2CException(busStr, devAddr, 0, "Invalid write size 0");
        case 1:
            i2cSize = I2C_SMBUS_BYTE_DATA;
            break;
        default:
            ...
            {
                throw I2CException(busStr, devAddr, 0, "Invalid write size");
            }
            i2cSize = I2C_SMBUS_BLOCK_DATA;
            break;
    }
