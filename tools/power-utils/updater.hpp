...
class Updater
{
  ...
  protected:
    ...
    const std::string getPsuInventoryPath()
    {
 ...
 * @param[in] numberOfBytesToRead - Number of bytes to read from firware file.
 * @param[in] numberOfBytesRead - Number of bytes read
 *
