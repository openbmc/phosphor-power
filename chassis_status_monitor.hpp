...
class ChassisStatusMonitor
{
  public:
    ...
    /**
     * Returns whether this chassis is powering on.
     *
     ...
     * obtained.
     *
     * @return true if chassis is powering on, false otherwise
     */
    virtual bool isPoweringOn() = 0;
    ...
    /**
     * Returns whether this chassis is powering off.
     *
     * Requires both power good and power state monitoring.
     *
     * Throws an exception if power good or power state monitoring is not
     ...
     * obtained.
     *
     * @return true if chassis is powering off, false otherwise
     */
    virtual bool isPoweringOff() = 0;
...
class BMCChassisStatusMonitor : public ChassisStatusMonitor
{
  public:
    ...
    /** @copydoc ChassisStatusMonitor::isPoweringOn() */
    virtual bool isPoweringOn() override
    {
        return ((getPowerState() == 1) && (getPowerGood() == 0));
    }
    ...
    /** @copydoc ChassisStatusMonitor::isPoweringOff() */
    virtual bool isPoweringOff() override
    {
        return ((getPowerState() == 0) && (getPowerGood() == 1));
    }
