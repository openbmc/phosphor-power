...
class BMCChassisStatusMonitor : public ChassisStatusMonitor
{
  public:
    ...
    /**
     * Returns the D-Bus inventory path for the chassis.
     *
     * This path is used for the Present, Available, and Enabled properties.
     *
     * @return D-Bus inventory path
     */
     ...
     */
    const char* getPowerInterface() const
    {
        return POWER_IFACE;
    }
